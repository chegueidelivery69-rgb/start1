...
import 'package:motoboy/features/home/presentation/pages/invoice_page/widget/fare_breakdown_widget.dart';
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          MyText(
                                            text: (userData!.onTripRequest!.isOutstation == 1 &&
                                                    ...
                                                    : (userData!.onTripRequest!.isRental == true &&
                                                        ...
                                                        : (userData!.onTripRequest!.isRental == true &&
                                                            ...
                                                            : (userData!.onTripRequest!.isRental == false &&
                                                                    userData!.onTripRequest!.goodsType.isEmpty)
